        ...
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    {{ \Composer\InstalledVersions::getPrettyVersion('marcogermani87/filament-cookie-consent') }}
                </p>
            </div>
            ...
            <div class="flex flex-col items-end gap-y-1">
                <x-filament::link
                    color="gray"
                    href="https://github.com/marcogermani87/filament-cookie-consent/blob/main/README.md"
