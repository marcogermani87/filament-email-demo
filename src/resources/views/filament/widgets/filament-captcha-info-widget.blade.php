<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    href="https://github.com/marcogermani87/filament-captcha"
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    {{ \Composer\InstalledVersions::getPrettyVersion('marcogermani87/filament-captcha') }}
                </p>
            </div>
            ...
            <div class="flex flex-col items-end gap-y-1">
                <x-filament::link
                    color="gray"
                    href="https://github.com/marcogermani87/filament-captcha/blob/main/README.md"
